...
export function getDefaultGoldenExemplars() {
  return [
    ...
    {
      id: 'seed-walmart-add-items-01',
      domain: 'walmart.com',
      sender_pattern: '%help@walmart.com%',
      email_archetype: 'logistics_parcels',
      sample_subject: 'Last chance to add items to your Walmart order. Changes can be made until 04:15am',
      sample_snippet: 'Your order #2000151-66891710 is being prepared. You can add items or edit quantities until 04:15am. Estimated delivery today between 9am - 1pm.',
      extracted_output: {
        intent: 'skip',
        actions: [{
          type: 'delivery',
          title: 'Walmart Order #2000151-66891710 (Being Prepared)',
          description: 'Walmart order #2000151-66891710 is being prepared for delivery today between 9am-1pm.',
          due_datetime: '2026-08-23T13:00:00Z',
          priority: 1,
          agency_level: 0,
          vendor: 'Walmart',
          transaction_id: '2000151-66891710',
          transaction_status: 'confirmed',
          is_perishable: true,
          source_origin: 'email_body',
        }],
        canonical_entity: {
          vendor: 'Walmart',
          vendorKey: 'walmart',
          orderId: '2000151-66891710',
          canonicalOrderId: '2000151-66891710',
          carrier: null,
          trackingNumber: null,
          compositeThreadKey: 'transaction:walmart:2000151-66891710',
          effectiveStage: 'confirmed',
          isPerishable: true,
          agencyLevel: 0,
        },
