...
import { Users, Sun, MessageSquare, Bot, ChevronRight, Music2, Palette, Home, Activity, BookmarkCheck, Layers, Sunset } from 'lucide-react'
...
const sections = [
  ...
  { to: '/settings/screensaver', icon: Sunset,        label: 'Art Mode & Sleep',        desc: 'Idle timers, painting rotation, display sleep' },
