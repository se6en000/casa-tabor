...
export default function BriefingPage() {
  ...
  return (
    ...
    <div className="briefing-page max-w-6xl mx-auto px-6 py-6">

      {/* Header */}
      <div className="flex items-start justify-between mb-6">
        <div>
          <h1 className="font-display text-display-md text-casa-text">{dateLabel}</h1>
        ...
        <div className="flex items-center gap-2">
          <Link
            to="/settings/ai"
            className="p-2 rounded-button border border-casa-border text-casa-muted hover:text-casa-text hover:bg-casa-bg transition-colors"
            title="AI Settings"
          >
            <Settings size={15} />
          </Link>
          <button
            ...
            className={cn(
              ...
              isGenerating
                ...
                : 'border-casa-border text-casa-text hover:bg-casa-bg',
            )}
          >
            ...
            briefing.summary_text ? (
              ...
              <div className="bg-casa-surface rounded-card border border-casa-border p-5 shadow-card text-center">
                <p className="text-body-sm text-casa-muted">
                  No AI summary — <Link to="/settings/ai" className="text-casa-text underline">add an API key</Link> to enable briefings.
                </p>
              </div>
            )
          )}
          ...
          <div className="w-full lg:w-[380px] xl:w-[440px] shrink-0 space-y-4">
            {memberList.length > 0 && (
              <div className="space-y-3">
                <h2 className="font-display text-heading text-casa-text flex items-center gap-2">
  ...
  return (
    <div className="bg-casa-surface rounded-card border border-casa-border shadow-card overflow-hidden">
      <div className="flex items-center gap-3 px-4 py-3 border-b border-casa-border">
        ...
        <span className="font-display text-heading text-casa-text">{member.name}</span>
  ...
  return (
    <div className="px-4 py-3 flex items-start gap-3">
      ...
      <div className="min-w-0 flex-1">
        <p className="text-body-sm font-medium text-casa-text leading-snug">{event.title}</p>
        {event.location_name && (
