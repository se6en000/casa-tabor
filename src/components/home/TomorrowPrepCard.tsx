      ...
      <div className="p-4 sm:p-5 relative z-10 space-y-4">
        ...
        {primaryTomorrowException && (
          <motion.div
            ...
            className={cn(
              'p-3.5 rounded-xl border relative overflow-hidden transition-all cursor-pointer select-none active:scale-[0.99] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-casa-gold',
              isNavy
                ? 'bg-slate-800/80 border-amber-500/30 text-white hover:bg-slate-700/90 hover:border-amber-400/50 hover:shadow-md'
                : 'bg-gradient-to-r from-amber-500/10 via-amber-500/5 to-transparent border-amber-500/30 text-casa-navy hover:bg-white hover:border-casa-gold/60 hover:shadow-sm',
            )}
          >
              ...
              {tomorrowDepartures.map((dep) => (
                <div
                  ...
                  className={cn(
                    ...
                    isNavy
                      ? dep.isException
                        ? 'bg-slate-800/80 border-amber-500/30 text-white hover:bg-slate-700/80 hover:border-amber-400/50'
                        : 'bg-slate-800/80 border-white/10 text-white hover:bg-slate-700/80 hover:border-white/25'
                      : dep.isException
                      ? 'border-amber-400/40 bg-amber-50/40 text-casa-navy hover:bg-white hover:border-casa-gold/60 hover:shadow-sm'
