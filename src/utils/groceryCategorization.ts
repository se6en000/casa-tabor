...
const CATEGORY_PHRASES: Record<Exclude<GroceryCategoryKey, 'other'>, string[]> = {
  ...
  pantry: ['olive oil', 'peanut butter', 'beef ramen', 'tuna canned', 'apple sauce', 'applesauce pouches'],
...
const CATEGORY_TOKENS: Record<Exclude<GroceryCategoryKey, 'other'>, Set<string>> = {
  produce: new Set([
    ...
    'lime', 'zucchini', 'potato', 'potatoes', 'mushroom', 'mushrooms',
  ]),
  ...
  pantry: new Set(['pasta', 'rice', 'cereal', 'oat', 'oats', 'flour', 'sugar', 'salt', 'oil', 'vinegar', 'sauce', 'soup', 'broth', 'stock', 'bean', 'beans', 'lentil', 'lentils', 'spice', 'seasoning', 'ketchup', 'mustard', 'mayo', 'ramen', 'applesauce']),
